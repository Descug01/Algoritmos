...
import numpy as np
import scipy as sp
from .util import data as utildata
...
class CORAL:
    ...
    def square_root_covariance(self, data, inverse=False):
        '''
    ...
    def fit(self, data):
        ...
        self: CORAL
            La propia instancia
        '''
        standarized = utildata.standarize(data)
    ...
    def fit_transform(self, source, target):
        ...
        '''
        self.fit(target)
        target_standarized = utildata.standarize(target)
